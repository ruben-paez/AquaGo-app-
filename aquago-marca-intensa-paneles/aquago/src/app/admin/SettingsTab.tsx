...
import { IconBank, IconBulb, IconHome, IconTag } from "@/components/icons";
  ...
  return (
    <div className="mt-4 max-w-2xl space-y-4">
      ...
      <div className="rounded-2xl border border-ink/10 bg-white p-5 shadow-card">
        <p className="font-display text-sm font-bold"><IconBank className="mr-1.5 inline h-4 w-4" />Datos para transferencias</p>
        ...
        <p className="mt-3 text-[11px] text-ink-soft">
          <IconBulb className="mr-1 inline h-4 w-4" /> Si dejás todo vacío, el checkout le avisa al cliente que los datos se
          confirman por WhatsApp al confirmar el pedido.
        </p>
      </div>

      <div className="rounded-2xl border border-ink/10 bg-white p-5 shadow-card">
        <p className="font-display text-sm font-bold"><IconHome className="mr-1.5 inline h-4 w-4" />Datos de la empresa</p>
      ...
      <div className="rounded-xl border border-ink/10 bg-white p-4 shadow-card">
        <p className="font-display text-sm font-bold"><IconTag className="mr-1.5 inline h-4 w-4" />Promo de lanzamiento</p>
        <p className="mt-0.5 text-xs text-ink-soft">
