...
import { IconBank, IconCash, IconClock, IconDroplet, IconMapPin, IconPhone, IconStar, IconTruck, IconUser } from "@/components/icons";
...
export default async function Home() {
  ...
  return (
    <div className="flex min-h-dvh flex-col bg-[#EAF6FF]">
      ...
      <main className="flex-1">
        {/* HERO */}
        <section className="relative overflow-hidden bg-[#0F2A52]">
          <div className="pointer-events-none absolute -right-40 -top-40 -z-10 h-[28rem] w-[28rem] rounded-full bg-[#56CCF2]/10 blur-3xl" />
          <div className="pointer-events-none absolute -left-24 -top-16 -z-10 hidden rotate-12 lg:block">
            <IconDroplet className="h-[26rem] w-[26rem] text-white opacity-[0.06]" />
          </div>
          <div className="pointer-events-none absolute inset-x-0 bottom-0" aria-hidden="true">
            <svg viewBox="0 0 1440 220" preserveAspectRatio="none" className="block h-[140px] w-full sm:h-[170px]">
              <path d="M0 120 C 240 40 480 200 720 140 C 960 80 1200 180 1440 110 L1440 220 L0 220 Z" fill="#1B8AD6" opacity="0.4" />
              <path d="M0 160 C 260 90 520 210 780 160 C 1040 110 1240 200 1440 150 L1440 220 L0 220 Z" fill="#56CCF2" opacity="0.35" />
              <path d="M0 190 C 300 130 560 225 840 185 C 1100 150 1280 215 1440 180 L1440 220 L0 220 Z" fill="#EAF6FF" />
            </svg>
          </div>
          <div className="relative z-10 mx-auto grid max-w-6xl items-center gap-10 px-4 py-14 pb-32 sm:px-6 lg:grid-cols-2 lg:gap-14 lg:py-20 lg:pb-28">
            <div>
              ...
              <h1 className="mt-5 font-display text-4xl font-bold leading-[1.08] tracking-tight text-white sm:text-5xl">
                ...
                <span className="text-[#56CCF2] underline decoration-[#1B8AD6] decoration-4 underline-offset-4">a domicilio</span> en Encarnación.
              </h1>
              <p className="mt-5 max-w-lg text-lg leading-relaxed text-[#B9D4EC]">
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                <div className="rounded-xl border border-white/15 bg-white/10 px-4 py-3 shadow-card backdrop-blur-sm">
                  <p className="text-[11px] font-bold uppercase tracking-wider text-[#9FC0DC]">Recarga 20 L</p>
                  <p className="font-display text-2xl font-bold text-white">{formatGs(12000)}</p>
                  <p className="text-[11px] font-semibold text-[#9FC0DC]">
                    {formatGs(13000)} con el servicio
                  </p>
                </div>
                <div className="rounded-xl border border-white/15 bg-white/10 px-4 py-3 shadow-card backdrop-blur-sm">
                  <p className="text-[11px] font-bold uppercase tracking-wider text-[#9FC0DC]">Bidón completo</p>
                  <p className="font-display text-2xl font-bold text-white">{formatGs(50000)}</p>
                  <p className="text-[11px] font-semibold text-[#9FC0DC]">
              ...
              <div className="mt-7 flex flex-wrap items-center gap-3">
                ...
                <a
                  href="#marcas"
                  className="rounded-xl border border-white/25 bg-white/10 px-6 py-3.5 font-display text-base font-bold text-white transition hover:border-[#56CCF2] hover:text-[#56CCF2]"
                >
                  Ver marcas
                </a>
              </div>

              <ul className="mt-8 flex flex-wrap gap-x-6 gap-y-2 text-sm font-semibold text-[#B9D4EC]">
            ...
            <div className="relative mx-auto w-full max-w-md">
              ...
              <div className="relative rounded-2xl border border-[#C9E6FA] bg-white p-5 shadow-pop">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-[11px] font-bold uppercase tracking-wider text-ink-soft">Pedido</p>
                    <p className="font-display text-lg font-bold text-ink">AQG-7K2M</p>
                  </div>
                ...
                <div className="mt-4 flex gap-4">
                  <div className="relative w-1 shrink-0">
                    ...
                    <span className="absolute left-1/2 top-[132px] grid h-7 w-7 -translate-x-1/2 place-items-center rounded-full bg-emerald-500/15 text-emerald-600">
              ...
              <p className="mt-3 text-center text-xs font-semibold text-[#9FC0DC]">
                ...
                <div
                  ...
                  className={`rounded-2xl border p-6 shadow-card transition ${
                    b.comingSoon
                      ...
                      : "border-[#C9E6FA] bg-white hover:-translate-y-0.5 hover:border-water-300"
                  }`}
                >
                  ...
                  {!b.comingSoon && (
                    <>
                      <div className="mt-4 flex flex-wrap gap-x-5 gap-y-2 text-sm font-semibold text-ink-soft">
                        ...
                        <span className="flex items-center gap-1.5">
                          <IconStar className="mr-0.5 inline h-3.5 w-3.5 text-amber-500" /> {formatRating(b.rating)}
                        </span>
                        <span className="flex items-center gap-1.5">
        ...
        <section id="catalogo" className="mx-auto max-w-6xl px-4 py-16 sm:px-6">
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {products.map((p, i) => (
              <div
                key={i}
                className="group rounded-xl border border-[#C9E6FA] bg-white p-5 shadow-card transition hover:-translate-y-0.5 hover:border-water-300"
              >
          ...
          <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6">
            ...
            <div className="mt-8 grid gap-4 md:grid-cols-4">
              {[
                ...
                <div key={i} className="relative rounded-xl border border-[#C9E6FA] bg-white p-6 shadow-card">
      ...
      <section id="app" className="mx-auto max-w-6xl px-4 pb-16 sm:px-6">
        <div className="relative overflow-hidden rounded-3xl border border-[#C9E6FA] bg-white p-8 text-center shadow-pop sm:p-12">
